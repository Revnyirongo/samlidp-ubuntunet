...
#[ORM\Entity(repositoryClass: IdpUserActionTokenRepository::class)]
#[ORM\Table(name: 'idp_user_action_tokens')]
#[ORM\UniqueConstraint(columns: ['token_hash'])]
#[ORM\HasLifecycleCallbacks]
class IdpUserActionToken
{
    ...
    #[ORM\ManyToOne(targetEntity: IdpUser::class)]
    #[ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')]
    private ?IdpUser $user = null;
    ...
    public function getUser(): ?IdpUser { return $this->user; }
    public function setUser(IdpUser $user): static { $this->user = $user; return $this; }
